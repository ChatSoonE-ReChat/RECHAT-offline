...
import com.chat_soon_e.re_chat.databinding.FragmentMyHiddenFolderBinding
...
class MyHiddenFolderFragment:Fragment() {
    ...
    private var activity_main: MainActivity? =null

    override fun onAttach(context: Context) {
        super.onAttach(context)
        activity_main= this.activity as MainActivity
    }
    ...
    override fun onCreateView(
        ...
        // 패턴이 맞지 않는다면 folderFragment 변환한다.
