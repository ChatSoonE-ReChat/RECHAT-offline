...
@Database(entities = [Chat::class, User::class, OtherUser::class, Folder::class, FolderContent::class, ChatList::class, Icon::class, BlockedChatList::class, PrivacyInformation::class], version = 1)
